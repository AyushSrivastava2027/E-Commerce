      ...
      <div className="w-full py-6 z-20">
        ...
        <form action className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto" onSubmit={handleLogin} >
          ...
          <div className="pb-2 pt-4">
            <input type="email" name="email" id="email" onChange={(e)=>setEmail(e.target.value)} placeholder="Email" className="block w-full p-2 text-lg rounded-sm bg-black" />
          </div>
          <div className="pb-2 pt-4">
            <input onChange={(e)=>setPassword(e.target.value)} className="block w-full p-2 text-lg rounded-sm bg-black"  type="password" name="password" id="password" placeholder="Password" />
          </div>
          <div className="text-right text-gray-400 hover:underline hover:text-gray-100">
            <a href="#">Forgot your password?</a>
          </div>
          <div className="px-4 pb-2 pt-4">
            <button type='submit' className="uppercase block w-full p-2 text-md rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">Login</button>
          </div>
